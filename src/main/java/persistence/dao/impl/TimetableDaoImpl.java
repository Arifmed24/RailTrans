...
public class TimetableDaoImpl extends GenericDaoImpl<Timetable> implements TimetableDao {
    ...
    @Override
    public List<Timetable> getStationTimetableDep(Station station, Date date) {
        ...
        TypedQuery<Timetable> query;
            query = em.createNamedQuery("Timetable.getStationTimetableDep", Timetable.class);
    ...
    public List<Timetable> getStationTimetableArr(Station station, Date date) {
        java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("yyyy-MM-dd");
        String datetime1 = sdf.format(date)+" 00:00:00";
        String datetime2 = sdf.format(date)+ " 23:59:59";
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        ...
        TypedQuery<Timetable> query;
        query = em.createNamedQuery("Timetable.getStationTimetableArr", Timetable.class);
        query.setParameter("station",station);
        query.setParameter("datetime",date1);
        query.setParameter("datetime2",date2);
        return query.getResultList();
